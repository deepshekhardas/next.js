              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   601 |       return
                   602 |     case 'prerender-client': {
                 > 603 |       React.use(
                       |             ^
                   604 |         makeClientHookHangingPromise(
                   605 |           workUnitStore.renderSignal,
                   606 |           new ClientHookDynamicError(workStore.route, expression) {
              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   541 |           // hang here and never resolve. This will cause the currently
                   542 |           // rendering component to effectively be a dynamic hole.
                 > 543 |           React.use(
                       |                 ^
                   544 |             makeClientHookHangingPromise(
                   545 |               workUnitStore.renderSignal,
                   546 |               new ParamClientHookDynamicError(workStore.route, expression) {
                   digest: 'CLIENT_HOOK_DYNAMIC'
                 }
                 To debug the issue, start the app in development mode by running \`next dev\`, then open "/client-hook-abort-reasons/normal/use-pathname/[id]" in your browser to investigate the error.
